    ...
    <div className="w-1/2 mx-auto p-6">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 ">
          ...
          <div className="card-lg w-full bg-base-100 shadow-xl mt-4 bg-sky-900">
          ...
          <div className="card-lg w-full bg-base-100 shadow-xl mt-4 bg-violet-800">
            <div className="card-body">
              <h2 className="card-title">Leaderboard</h2>
              <p>Leaderboard coming soon...........</p>
            </div>
          ...
          <div className="card-lg w-full bg-base-100 shadow-xl mt-4 bg-pink-500">
            <div className="card-body">
              <h2 className="card-title">Leaderboard</h2>
